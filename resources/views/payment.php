                    ...
                    <div class="col-12 col-xl-6">
                        <div class="pb-8 ps-xl-8">
                            <div class="position-relative m-4">
                                ...
                                <a href="/reservation" class="position-absolute top-0 start-0 translate-middle btn btn-sm btn-square btn-primary rounded-circle">1</a>
                                <a href="/info" class="position-absolute top-0 start-33 translate-middle btn btn-sm btn-square btn-primary rounded-circle">2</a>
                        ...
                        <div class="card bg-white shadow-sm h-100 card-selected">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="/info" class="fw-semibold text-secondary link-hover-primary d-inline-block">
                                        <i class="hicon hicon-edit"></i>
                                        <span>Edit</span>
                                    </a>
                                </div>
