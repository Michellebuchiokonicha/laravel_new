...
<!-- Mirrored from bilury.bithemer.com/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 10:37:40 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="vh-100 vw-100 overflow-hidden bg-light">
    ...
    <main>
        <!-- Contact -->
        <section id="contact" class="pt-24 pb-14">
            <div class="container">
                <h1 class="mb-8 display-5 text-uppercase ff-heading">Contact</h1>
                <div class="row" data-cues="fadeIn">
                    <div class="col-12 col-xl-3">
                        <!-- Contac Information -->
                        <div class="mb-4">
                            <div class="heading">
                                <h1 class="title h4 text-uppercase ff-sub ls-1">Contact Bilury</h1>
                            </div>
                            <div class="row">
                                <div class="col-12 col-xl-12 col-lg-4">
                                    <div class="mb-4">
                                        ...
                                        <div class="fw-bold-2">610 Placer Loquen, Paris, France.</div>
                                    </div>
                                </div>
                                <div class="col-12 col-xl-12 col-lg-4 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="fw-bold-2">+33 321-654-9876 (Ext: 123).</div>
                                    </div>
                                </div>
                                <div class="col-12 col-xl-12 col-lg-4 col-md-6">
                                    <div class="mb-4">
                    ...
                    <div class="col-12 col-xl-9">
                        ...
                        <form class="needs-validation mb-4" method="post" novalidate="">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h2 class="h4 text-uppercase ff-sub ls-1">Send an Email</h2>
                            ...
                            <div class="row gx-4">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-5">
                                        <textarea id="form_message" name="message" class="form-control" placeholder="Message" style="height: 150px" required></textarea>
